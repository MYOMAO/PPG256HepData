...
void All(){
	...
	TString DataName = "PHENIX: #sqrt{s} = 200 GeV, 1.2 < |y| < 2.2, Same Arms";
	TString DataName2 = "PHENIX: Same Arms, Muon Subtracted";
	TString DataName3 = "PHENIX: Opposite Arms";
...
//	STAR->SetMarkerStyle(21);
	...
	ALICEMidRap->SetLineColor(kBlack);
	ALICEMidRap->SetMarkerColor(kBlack);
	ALICEMidRapSyst->SetFillColorAlpha(kBlack,0.5);
	ALICEMidRapSyst->SetLineColor(kBlack);
	...
	TLegend * leg = new TLegend(0.20,0.68,0.37,0.96,NULL,"brNDC");
	leg->SetBorderSize(0);
	...
	TString infile3 = "OppUnCorr.root";


	TFile * fin3 = new TFile(infile3.Data());

	TGraphErrors * Inclusive3 = (TGraphErrors * ) fin3->Get("Inclusive");
	TGraphErrors *Syst3 = (TGraphErrors *) fin3->Get("InclusiveSyst");

	Inclusive3->SetMarkerColor(kBlue);
	Inclusive3->SetLineColor(kBlue);
	...
	Inclusive2->SetMarkerStyle(47);

	Inclusive2->Draw("epSAME");
	Syst2->Draw("5SAME");


	Inclusive3->SetMarkerStyle(21);

	Inclusive3->Draw("epSAME");
	Syst3->Draw("5SAME");
	...
	leg->AddEntry(Inclusive3,DataName3.Data(),"LP");
	...
	leg->Draw("SAME");
	lat->DrawLatex(0.62,0.35,"N_{ch} #eta range");
	lat->DrawLatex(0.62,0.30,"PHENIX: 1.2 < |#eta| < 2.4");
	lat->DrawLatex(0.62,0.25,"STAR: |#eta| < 1");
	lat->DrawLatex(0.62,0.20,"ALICE: |#eta| < 1");


	c->SaveAs("Fig1All.png");
	c->SaveAs("Fig1All.pdf");

...
void All(){
	...
	TString DataName = "PHENIX: #sqrt{s} = 200 GeV, 1.2 < |y| < 2.2, |#Delta#eta| = 0";
	TString DataName2 = "PHENIX: |#Delta#eta| = 0, Muon Subtracted";
	TString DataName3 = "PHENIX: |#Delta#eta| = 3.4";
...
//	STAR->SetMarkerStyle(21);
	STAR->SetMarkerStyle(kFullCrossX);
